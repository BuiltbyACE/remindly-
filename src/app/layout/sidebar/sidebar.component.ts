            ...
            <li *appPermission="item.permission">
              @if (item.external) {
                ...
                >
                  ...
                  {{ item.label }}
                  <svg style="margin-left:auto;width:14px;height:14px;opacity:0.4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export class SidebarComponent {
  ...
  readonly adminUrl = 'https://remindly-backend-production-a3a0.up.railway.app/admin';
